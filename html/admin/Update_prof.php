    ...
    <div class="container">
      ...
      <?php
        ...
        <?php
          ...
          if(isset($_GET['id_P'])){
            $req ="SELECT * FROM Profs WHERE id_P='{$_GET['id_P']}'";
            // echo $req;
            $resultat=mysqli_query($cnx,$req);
            $ligne=mysqli_fetch_assoc($resultat);
                    ...
                    ?>    
           <div>
           <h1>Modifier prof :<?= $ligne['nom_P']?></h1>
           <table>
              <form action="" method="POST">
                <tr>
                  <th>id:</th>
                  <th><input type="text" value="<?= $ligne['id_P']?>" name="id_P"></th>
                </tr>
                <tr>
                  <th>nom:</th>
                  <th><input type="text" value="<?= $ligne['nom_P']?>"name="nom_P"></th>
                </tr>
                <tr>
                  <th>telephone:</th>
                  <th><input type="text" value="<?= $ligne['telephone_P']?>"name="telephone_P"></th>
                </tr>
                <tr>
                  <th>email:</th>
                  <th><input type="text" value="<?= $ligne['email_P']?>"name="email_P"></th>
                </tr>
                <tr>
