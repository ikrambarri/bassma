        ...
        <h1>Ajouter etudiant</h1>
          ...
          <form action="" method="POST">
            ...
            <tr>
                ...
                <td><input type="text" name="NiveauScolaire"></td>
            </tr>
            <tr>
                <th>matiere</th>
            ...
            if (isset($_POST["btn"])) {
                ...
                if (preg_match($modele, $ch)) {
                    if (preg_match($modelephone, $phone)) {
                        ...
                        $dateNaiss = mysqli_real_escape_string($cnx, $_POST['dateNaiss']);
                        $email = mysqli_real_escape_string($cnx, $_POST['email']);
                        $tele = mysqli_real_escape_string($cnx, $_POST['telephone']);
                        $adresse = mysqli_real_escape_string($cnx, $_POST['adresse']);
                        $Niveau = mysqli_real_escape_string($cnx, $_POST['NiveauScolaire']);
