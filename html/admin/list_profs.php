    ...
    <div class="container">
      ...
      <?php
           ...
           <?php
            ...
            <tbody>
              <tr>
                     <td><?= $ligne['id_P']?></td>
                    <td><?= $ligne['nom_P']?></td>
                    <td><?= $ligne['telephone_P']?></td>
                    <td><?= $ligne['email_P']?></td>
                    <td><a href="Update_prof.php?id_P=<?= $ligne['id_P'] ?>"class="material-symbols-sharp">Edit</a> </td>
                    <?php
                        //delete
                        if(isset($_GET['delete'])){
                            $delete=$_GET['delete'];
                            $req = "DELETE FROM Profs WHERE id_P='$delete'"; 
                            mysqli_query($cnx, $req);
                         }
                     ?>
                    <td><a href="list_profs.php?delete=<?=$ligne['id_P']?>" class="material-symbols-sharp">Delete </a> </td>
                </tr>
            </tbody>
         <?php
            }
        ?>  
          ...
          <a href="pdf_Profs.php" id="bottone5">download</a>
          <a href="Ajouter_Prof.php" id="bottone5">Add</a>
        </div>
