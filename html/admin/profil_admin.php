    ...
    <div class="container">
      ...
      <?php
           ...
           <?php
            ...
            <tbody>
              <tr>
                    ...
                    <td><?= $ligne['email']?></td>
                    <td><?= $ligne['adresse']?></td>
                    <td><?= $ligne['NiveauScolaire']?></td>
                    <td><?= $ligne['matiere']?></td>
                    <td><a href="Update_etudiant.php?id_E=<?= $ligne['id_E'] ?>" class="material-symbols-sharp">Edit</a></td>

                    <?php
                        //delete
                        if(isset($_GET['delete'])){
                            $delete=$_GET['delete'];
                            $req = "DELETE FROM Etudiant_C WHERE id_E='$delete'"; 
                            mysqli_query($cnx, $req);
                         }
                     ?>
                    <td><a href="profil_admin.php?delete=<?=$ligne['id_E']?>" class="material-symbols-sharp">Delete </a> </td>
                </tr>
            </tbody>
        ...
        ?>  
          ...
          <a href="pdf_Etudiant.php" id="bottone5">download</a>
          <a href="Ajouter_Etudiant.php" id="bottone5">Add</a>
        </div>
